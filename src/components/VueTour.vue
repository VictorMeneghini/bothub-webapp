      ...
      steps: [
        {
          ...
          content: 'Inicie <strong>Tour</strong>',
        },
      ],
      callbacks: {
...
<style scoped>
  ...
  .v-step .v-step__arrow--dark[data-v-1c0035bb] {
    border-color: #454d5d
  }

  .v-step[x-placement^=top][data-v-1c0035bb] {
    margin-bottom: .5rem
  }
  ...
  .v-step[x-placement^=bottom][data-v-1c0035bb] {
    margin-top: .5rem
  }
  ...
  .v-step[x-placement^=right][data-v-1c0035bb] {
    margin-left: .5rem
  }
  ...
  .v-step[x-placement^=left][data-v-1c0035bb] {
    margin-right: .5rem
  }
  ...
  .v-step__header[data-v-1c0035bb] {
  ...
  .v-step__content[data-v-1c0035bb] {
    margin: 0 0 1rem 0
  }
